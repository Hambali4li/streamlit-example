...
class perpus:
    ...
    def kembalikanbuku(self):
        ...
        if (konfirm == 'Ya' or konfirm == 'ya' or konfirm == 'Y' or konfirm == 'y'):
            if(tglkembali==tglsekarang):
                ...
                print("\033[31mANDA TERLAMBAT MENGEMBALIKAN BUKU, ANDA AKAN DIKENAKAN DENDA 1.000 rupiah PER HARINYA\033[0m")
    ...
    def daftarpinjam(self):
        ...
        print("Nama : %s\tJudul Buku : %s\tTanggal Pinjam : %s\tTanggal Kembali : %s"% (arynama,aryjudul,arytglpinjam,arytglkembali))
    ...
    4. Peminjam wajib memiliki Struk Bukti Pinjam saat akan hendak meminjam buku.
    5. Saat mengembalikan buku, peminjam wajib membawa dan menunjukkan Struk Kertas Bukti Pinjam kepada
    ...
    1. Keterlambatan pengembalian buku dikenakan sanksi denda sesuai dengan peraturan dan tata 
       tertib yang telah ditentukan, yaitu Rp. 1.000,- untuk 1 (satu) buku per hari.
    ...
    3. Jika peminjam tidak mentaati peraturan dan tata tertib dari perpustakaan PROA Digitalent maka 
       peminjam akan di-blacklist dari perpustakaan ini''')
        time.sleep(1)
